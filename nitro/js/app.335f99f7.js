        ...
        class Gt {
            ...
            initObserver() {
                I.$off(F), I.$on(F, async t => {
                    ...
                    try {
                        const e = await this.web3.eth.personal.sign("shib_nitro_dapp", t[0]);
                        this.signature = e
                    } catch (e) {
            ...
            Ge = {
                ...
                methods: { ...Object(E["b"])({
                    ...
                    async handleExportOld() {
                        this.alertModalTitle = "Warning", this.alertModalIcon = "warning", this.alertModalActive = !0, this.alertModalContent = "Previous accounts are encrypted using the siganture of 'shib_nitro'. Please sign this string to export the private key of old accounts.", this.alertModalBtnOk = "Ok", this.alertModalCallback = async () => {
                            this.alertModalActive = !1;
                            const t = await qt.web3.eth.personal.sign("Shib_Nitro", qt.address),
                                e = B.getAccountQuery();
